#!/bin/bash
## This script is written by Nathan S. Watson-Haigh and downloaded from https://gist.github.com/nathanhaigh/3521724
## SPECIAL ATTETION here: the option compress is not supported in the actual environment, beacuse the pigz command is missing
##
